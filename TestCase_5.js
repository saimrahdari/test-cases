...
await driver.sleep(5000);
await driver
.findElement(By.xpath(`/html/body/div/div[2]/div/div/button`)) .click();
let text = await driver .findElement(By.xpath(`/html/body/div/div[2]/h4`)) .getText();
if (text === '0') {
...
console.log('Test Case-5 failed.'); } finally {
        await driver.quit();
    }
};
